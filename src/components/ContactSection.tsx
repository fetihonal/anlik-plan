              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@anlikplan.com"
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Web sitemizden etkinlik sayfasına giderek kayıt
                    olabilirsiniz.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold">
                    Etkinlik ücretleri neye göre belirleniyor?
                  </h4>
                  <p className="text-gray-600">
                    Etkinliğin formatı, süresi ve içeriğine göre fiyatlandırma
                    yapılmaktadır.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold">
                    Kendi etkinlik fikrimi paylaşabilir miyim?
                  </h4>
                  <p className="text-gray-600">
                    Evet, iletişim formu üzerinden etkinlik önerilerinizi
