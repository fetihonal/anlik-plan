    ...
    <section className="relative bg-wave-gradient text-white overflow-hidden">
      ...
      <div className="container-custom relative z-10 py-20 md:py-32 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/90 max-w-lg">
            Anlık Plan; eğlenceli aktiviteler, quiz geceleri, temalı partiler,
            fake düğünler ve daha fazlasıyla yeni insanlarla tanışabileceğin
            sosyal bir topluluk.
          </p>
        ...
        <div className="md:w-1/2 relative">
          <div className="relative h-[300px] md:h-[400px] w-full">
            <Image
              src="https://bzyskxkobbtdwfjqijsj.supabase.co/storage/v1/object/public/event-images/events/1a0c4c754dbfa352b05b7efa34dfb8a0.jpg"
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg
          ...
          className="w-full h-[60px] text-light">
          <path
            fill="currentColor"
            fillOpacity="1"
            d="M0,96L80,106.7C160,117,320,139,480,133.3C640,128,800,96,960,90.7C1120,85,1280,107,1360,117.3L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
        </svg>
      </div>
    </section>
  );
